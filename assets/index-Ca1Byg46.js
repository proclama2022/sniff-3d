...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ti,depthTest:!1,depthWrite:!1})}function Su(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rc(),fragmentShader:`
		...
		`,blending:Ti,depthTest:!1,depthWrite:!1})}function Eu(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rc(),fragmentShader:`
 ...
 */var Vo=qc,cM=aM;function lM(r,e){return r===e&&(r!==0||1/r===1/e)||r!==r&&e!==e}var uM=typeof Object.is=="function"?Object.is:lM,hM=cM.useSyncExternalStore,fM=Vo.useRef,dM=Vo.useEffect,pM=Vo.useMemo,mM=Vo.useDebugValue;Ff.useSyncExternalStoreWithSelector=function(r,e,t,n,i){var s=fM(null);if(s.current===null){var o={hasValue:!1,value:null};s.current=o}else o=s.current;s=pM(function(){function c(d){if(!l){if(l=!0,u=d,d=n(d),i!==void 0&&o.hasValue){var _=o.value;if(i(_,d))return h=_}return h=d}if(_=h,uM(u,d))return _;var g=n(d);return i!==void 0&&i(_,g)?(u=d,_):(u=d,h=g)}var l=!1,u,h,f=t===void 0?null:t;return[function(){return c(e())},f===null?void 0:function(){return c(f())}]},[e,t,n,i]);var a=hM(r,s[0],s[1]);return dM(function(){o.hasValue=!0,o.value=a},[a]),mM(a),a};Of.exports=Ff;var gM=Of.exports;const _M=Rf(gM),kf={},{useDebugValue:xM}=Zy,{useSyncExternalStoreWithSelector:vM}=_M;let gh=!1;const yM=r=>r;function MM(r,e=yM,t){(kf?"production":void 0)!=="production"&&t&&!gh&&(console.warn("[DEPRECATED] Use `createWithEqualityFn` instead of `create` or use `useStoreWithEqualityFn` instead of `useStore`. They can be imported from 'zustand/traditional'. https://github.com/pmndrs/zustand/discussions/1937"),gh=!0);const n=vM(r.subscribe,r.getState,r.getServerState||r.getInitialState,e,t);return xM(n),n}const _h=r=>{(kf?"production":void 0)!=="production"&&typeof r!="function"&&console.warn("[DEPRECATED] Passing a vanilla store will be unsupported in a future version. Instead use `import { useStore } from 'zustand'`.");const e=typeof r=="function"?Uy(r):r,t=(n,i)=>MM(e,n,i);return Object.assign(t,e),t},SM=r=>r?_h(r):_h,St={grass:{dark:"#558B2F"},dirt:{dark:"#5D4037"},sky:{top:"#87CEEB",horizon:"#F5DEB3"},rare:"#4DB6AC",scent:"#CE93D8",buttonPrimary:"#558B2F",buttonAction:"#FF6F00",textDark:"#3E2723"},bn={lowEnd:{shadowMapSize:512,pixelRatio:1.5,antialias:!1,treeCount:30,fogNear:20,fogFar:60},highEnd:{shadowMapSize:1024,pixelRatio:2,antialias:!0,treeCount:50,fogNear:30,fogFar:100},dog:{moveSpeed:3,rotationSpeed:5,targetReachedThreshold:.5},camera:{distance:8,height:6,lerpSpeed:.1},scent:{spotRadius:1.5}};var Lt=(r=>(r.NEUTRAL="neutral",r.CURIOUS="curious",r.CONVINCED="convinced",r.ALMOST="almost",r.CONFUSED="confused",r))(Lt||{}),ri=(r=>(r.COMMON="common",r.RARE="rare",r.NOTHING="nothing",r))(ri||{});const EM=(r,e)=>{const t=[],n=[ri.COMMON,ri.RARE,ri.NOTHING],i=[.5,.3,.2];for(let s=0;s<r;s++){const o=Math.random();let a=ri.COMMON,c=0;for(let l=0;l<n.length;l++)if(c+=i[l],o<c){a=n[l];break}t.push({id:`scent-${s}`,position:{x:(Math.random()-.5)*e,z:(Math.random()-.5)*e},truffleType:a,discovered:!1,dug:!1})}return t},kt=SM((r,e)=>({phase:"home",isLoading:!0,dogPosition:{x:0,y:0,z:0},dogTarget:null,dogEmotionalState:Lt.NEUTRAL,dogIsMoving:!1,dogIsSniffing:!1,dogIsDigging:!1,scentSpots:[],nearestScentSpot:null,scentIntensity:0,isScentActive:!1,collectedTruffles:[],isDigAvailable:!1,setPhase:t=>r({phase:t}),setLoading:t=>r({isLoading:t}),setDogPosition:t=>{r({dogPosition:t}),e().updateNearestScentSpot()},setDogTarget:t=>r({dogTarget:t}),setDogEmotionalState:t=>r({dogEmotionalState:t}),setDogMoving:t=>r({dogIsMoving:t}),setDogSniffing:t=>r({dogIsSniffing:t}),setDogDigging:t=>r({dogIsDigging:t}),setScentSpots:t=>r({scentSpots:t}),updateNearestScentSpot:()=>{const{dogPosition:t,scentSpots:n}=e();if(n.length===0)return;let i=null,s=1/0;for(const u of n){if(u.dug)continue;const h=t.x-u.position.x,f=t.z-u.position.z,d=Math.sqrt(h*h+f*f);d<s&&(s=d,i=u)}const a=i?Math.max(0,1-s/15):0;let c=Lt.NEUTRAL;i&&(s<2?c=Lt.ALMOST:s<5?c=Lt.CONVINCED:s<10&&(c=Lt.CURIOUS));const l=i!==null&&s<2;r({nearestScentSpot:i,scentIntensity:a,dogEmotionalState:c,isDigAvailable:l})},setScentIntensity:t=>r({scentIntensity:t}),setScentActive:t=>r({isScentActive:t}),setDigAvailable:t=>r({isDigAvailable:t}),collectTruffle:t=>{r(n=>({collectedTruffles:[...n.collectedTruffles,{type:t,timestamp:Date.now()}]}))},digAtNearestSpot:()=>{const{nearestScentSpot:t,scentSpots:n}=e();if(!t||t.dug)return null;const i=n.map(s=>s.id===t.id?{...s,dug:!0}:s);return r({scentSpots:i,nearestScentSpot:null,isDigAvailable:!1}),e().collectTruffle(t.truffleType),t.truffleType},startGame:()=>{const t=EM(8,30);r({phase:"playing",scentSpots:t,dogPosition:{x:0,y:0,z:0},dogTarget:null,dogEmotionalState:Lt.NEUTRAL,collectedTruffles:[],isDigAvailable:!1,isScentActive:!1})},endGame:()=>r({phase:"results"}),resetGame:()=>r({phase:"home",dogPosition:{x:0,y:0,z:0},dogTarget:null,dogEmotionalState:Lt.NEUTRAL,scentSpots:[],nearestScentSpot:null,collectedTruffles:[],isDigAvailable:!1})}));class TM{constructor(e,t){_e(this,"canvas");_e(this,"camera");_e(this,"raycaster");_e(this,"groundPlane");_e(this,"touchStartPos",null);_e(this,"isDragging",!1);_e(this,"dragThreshold",10);this.canvas=e,this.camera=t,this.raycaster=new Zv,this.groundPlane=new _i(new D(0,1,0),0),this.setupEventListeners()}setupEventListeners(){this.canvas.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),this.canvas.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),this.canvas.addEventListener("touchend",this.handleTouchEnd.bind(this),{passive:!1}),this.canvas.addEventListener("mousedown",this.handleMouseDown.bind(this)),this.canvas.addEventListener("mousemove",this.handleMouseMove.bind(this)),this.canvas.addEventListener("mouseup",this.handleMouseUp.bind(this))}handleTouchStart(e){if(e.preventDefault(),e.touches.length===1){const t=e.touches[0];this.touchStartPos={x:t.clientX,y:t.clientY},this.isDragging=!1}}handleTouchMove(e){if(e.preventDefault(),e.touches.length===1&&this.touchStartPos){const t=e.touches[0],n=t.clientX-this.touchStartPos.x,i=t.clientY-this.touchStartPos.y;Math.sqrt(n*n+i*i)>this.dragThreshold&&(this.isDragging=!0)}}handleTouchEnd(e){if(e.preventDefault(),!this.isDragging&&e.changedTouches.length===1){const t=e.changedTouches[0];this.processInput(t.clientX,t.clientY)}this.touchStartPos=null,this.isDragging=!1}handleMouseDown(e){this.touchStartPos={x:e.clientX,y:e.clientY},this.isDragging=!1}handleMouseMove(e){if(this.touchStartPos){const t=e.clientX-this.touchStartPos.x,n=e.clientY-this.touchStartPos.y;Math.sqrt(t*t+n*n)>this.dragThreshold&&(this.isDragging=!0)}}handleMouseUp(e){!this.isDragging&&this.touchStartPos&&this.processInput(e.clientX,e.clientY),this.touchStartPos=null,this.isDragging=!1}processInput(e,t){const n=this.canvas.getBoundingClientRect(),i=(e-n.left)/n.width*2-1,s=-((t-n.top)/n.height)*2+1;this.raycaster.setFromCamera(new Pe(i,s),this.camera);const o=new D;this.raycaster.ray.intersectPlane(this.groundPlane,o),o&&kt.getState().setDogTarget({x:o.x,z:o.z})}dispose(){this.canvas.removeEventListener("touchstart",this.handleTouchStart.bind(this)),this.canvas.removeEventListener("touchmove",this.handleTouchMove.bind(this)),this.canvas.removeEventListener("touchend",this.handleTouchEnd.bind(this)),this.canvas.removeEventListener("mousedown",this.handleMouseDown.bind(this)),this.canvas.removeEventListener("mousemove",this.handleMouseMove.bind(this)),this.canvas.removeEventListener("mouseup",this.handleMouseUp.bind(this))}}class bM{constructor(e,t,n=!1){_e(this,"scene");_e(this,"assets");_e(this,"trees",[]);_e(this,"ground");_e(this,"settings");this.scene=e,this.assets=t,this.settings=n?bn.lowEnd:bn.highEnd,this.createWorld()}createWorld(){this.createSky(),this.createGround(),this.createTrees(),this.createLighting(),this.createFog()}createSky(){const e=new Bn(100,32,32),t=new oi({uniforms:{topColor:{value:new xe(St.sky.top)},horizonColor:{value:new xe(St.sky.horizon)}},vertexShader:`
      ...
      `,side:$t}),n=new Ye(e,t);this.scene.add(n)}createGround(){const t=new ko(60,60,32,32),n=t.attributes.position;for(let s=0;s<n.count;s++){const o=n.getX(s),a=n.getY(s),c=n.getZ(s),l=Math.sin(o*.5)*Math.cos(a*.5)*.2;n.setXYZ(s,o,a,c+l)}t.computeVertexNormals();const i=new Yi({color:St.grass.dark,map:this.assets.textures.grass});this.ground=new Ye(t,i),this.ground.rotation.x=-Math.PI/2,this.ground.receiveShadow=!0,this.scene.add(this.ground)}createTrees(){const e=this.settings.treeCount,t=25;for(let n=0;n<e;n++){const i=this.assets.treeModels[0].clone();let s,o;do s=(Math.random()-.5)*t*2,o=(Math.random()-.5)*t*2;while(Math.sqrt(s*s+o*o)<5);i.position.set(s,0,o);const a=.7+Math.random()*.6;i.scale.setScalar(a),i.rotation.y=Math.random()*Math.PI*2,this.trees.push(i),this.scene.add(i)}}createLighting(){const e=new Uv(St.sky.top,St.grass.dark,.6);this.scene.add(e);const t=new bf("#FFF5E1",1);t.position.set(10,20,10),t.castShadow=!0,t.shadow.mapSize.width=this.settings.shadowMapSize,t.shadow.mapSize.height=this.settings.shadowMapSize,t.shadow.camera.near=.5,t.shadow.camera.far=50,t.shadow.camera.left=-20,t.shadow.camera.right=20,t.shadow.camera.top=20,t.shadow.camera.bottom=-20,t.shadow.bias=-1e-4,this.scene.add(t)}createFog(){this.scene.fog=new Cc(St.sky.horizon,this.settings.fogNear,this.settings.fogFar)}getGround(){return this.ground}getTrees(){return this.trees}update(e){}dispose(){this.trees.forEach(e=>{e.traverse(t=>{t instanceof Ye&&(t.geometry.dispose(),t.material instanceof Rn&&t.material.dispose())})}),this.trees=[]}}function Qn(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function Gf(r,e){r.prototype=Object.create(e.prototype),r.prototype.constructor=r,r.__proto__=e}/*!
 * GSAP 3.14.2
 * https://gsap.com
 *
...
*/var dn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Wr={duration:.5,overwrite:!1,delay:0},Yc,Nt,at,An=1e8,et=1/An,oc=Math.PI*2,AM=oc/4,wM=0,Hf=Math.sqrt,RM=Math.cos,CM=Math.sin,Ut=function(e){return typeof e=="string"},vt=function(e){return typeof e=="function"},ai=function(e){return typeof e=="number"},jc=function(e){return typeof e>"u"},Hn=function(e){return typeof e=="object"},en=function(e){return e!==!1},Kc=function(){return typeof window<"u"},go=function(e){return vt(e)||Ut(e)},Vf=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Ht=Array.isArray,PM=/random\([^)]+\)/g,LM=/,\s*/g,xh=/(?:-?\.?\d|\.)+/gi,Wf=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,wr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Oa=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Xf=/[+-]=-?[.\d]+/,DM=/[^,'"\[\]\s]+/gi,IM=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,dt,On,ac,$c,pn={},Po={},qf,Yf=function(e){return(Po=Xr(e,pn))&&sn},Zc=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},As=function(e,t){return!t&&console.warn(e)},jf=function(e,t){return e&&(pn[e]=t)&&Po&&(Po[e]=t)||pn},ws=function(){return 0},UM={suppressEvents:!0,isStart:!0,kill:!1},vo={suppressEvents:!0,kill:!1},NM={suppressEvents:!0},Jc={},wi=[],cc={},Kf,ln={},Fa={},vh=30,yo=[],Qc="",el=function(e){var t=e[0],n,i;if(Hn(t)||vt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=yo.length;i--&&!yo[i].targetTest(t););n=yo[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new vd(e[i],n)))||e.splice(i,1);return e},Ji=function(e){return e._gsap||el(wn(e))[0]._gsap},$f=function(e,t,n){return(n=e[t])&&vt(n)?e[t]():jc(n)&&e.getAttribute&&e.getAttribute(t)||n},tn=function(e,t){return(e=e.split(",")).forEach(t)||e},Mt=function(e){return Math.round(e*1e5)/1e5||0},ft=function(e){return Math.round(e*1e7)/1e7||0},Dr=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},OM=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},Lo=function(){var e=wi.length,t=wi.slice(0),n,i;for(cc={},wi.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},tl=function(e){return!!(e._initted||e._startAt||e.add)},Zf=function(e,t,n,i){wi.length&&!Nt&&Lo(),e.render(t,n,!!(Nt&&t<0&&tl(e))),wi.length&&!Nt&&Lo()},Jf=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(DM).length<2?t:Ut(e)?e.trim():e},Qf=function(e){return e},mn=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},FM=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},Xr=function(e,t){for(var n in t)e[n]=t[n];return e},yh=function r(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=Hn(t[n])?r(e[n]||(e[n]={}),t[n]):t[n]);return e},Do=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},vs=function(e){var t=e.parent||dt,n=e.keyframes?FM(Ht(e.keyframes)):mn;if(en(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},BM=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},ed=function(e,t,n,i,s){var o=e[i],a;if(s)for(a=t[s];o&&o[s]>a;)o=o._prev;return o?(t._next=o._next,o._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=o,t.parent=t._dp=e,t},Wo=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=t._prev,o=t._next;s?s._next=o:e[n]===t&&(e[n]=o),o?o._prev=s:e[i]===t&&(e[i]=s),t._next=t._prev=t.parent=null},Ci=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Qi=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},zM=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},lc=function(e,t,n,i){return e._startAt&&(Nt?e._startAt.revert(vo):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},kM=function r(e){return!e||e._ts&&r(e.parent)},Mh=function(e){return e._repeat?qr(e._tTime,e=e.duration()+e._rDelay)*e:0},qr=function(e,t){var n=Math.floor(e=ft(e/t));return e&&n===e?n-1:n},Io=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Xo=function(e){return e._end=ft(e._start+(e._tDur/Math.abs(e._ts||e._rts||et)||0))},qo=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=ft(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Xo(e),n._dirty||Qi(n,e)),e},td=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Io(e.rawTime(),t),(!t._dur||Os(0,t.totalDuration(),n)-t._tTime>et)&&t.render(n,!0)),Qi(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-et}},kn=function(e,t,n,i){return t.parent&&Ci(t),t._start=ft((ai(n)?n:n||e!==dt?xn(e,n,t):e._time)+t._delay),t._end=ft(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),ed(e,t,"_first","_last",e._sort?"_start":0),uc(t)||(e._recent=t),i||td(e,t),e._ts<0&&qo(e,e._tTime),e},nd=function(e,t){return(pn.ScrollTrigger||Zc("scrollTrigger",t))&&pn.ScrollTrigger.create(t,e)},id=function(e,t,n,i,s){if(il(e,t,s),!e._initted)return 1;if(!n&&e._pt&&!Nt&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Kf!==un.frame)return wi.push(e),e._lazy=[s,i],1},GM=function r(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||r(t))},uc=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},HM=function(e,t,n,i){var s=e.ratio,o=t<0||!t&&(!e._start&&GM(e)&&!(!e._initted&&uc(e))||(e._ts<0||e._dp._ts<0)&&!uc(e))?0:1,a=e._rDelay,c=0,l,u,h;if(a&&e._repeat&&(c=Os(0,e._tDur,t),u=qr(c,a),e._yoyo&&u&1&&(o=1-o),u!==qr(e._tTime,a)&&(s=1-o,e.vars.repeatRefresh&&e._initted&&e.invalidate())),o!==s||Nt||i||e._zTime===et||!t&&e._zTime){if(!e._initted&&id(e,t,i,n,c))return;for(h=e._zTime,e._zTime=t||(n?et:0),n||(n=t&&!h),e.ratio=o,e._from&&(o=1-o),e._time=0,e._tTime=c,l=e._pt;l;)l.r(o,l.d),l=l._next;t<0&&lc(e,t,n,!0),e._onUpdate&&!n&&hn(e,"onUpdate"),c&&e._repeat&&!n&&e.parent&&hn(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===o&&(o&&Ci(e,1),!n&&!Nt&&(hn(e,o?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},VM=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},Yr=function(e,t,n,i){var s=e._repeat,o=ft(t)||0,a=e._tTime/e._tDur;return a&&!i&&(e._time*=o/e._dur),e._dur=o,e._tDur=s?s<0?1e10:ft(o*(s+1)+e._rDelay*s):o,a>0&&!i&&qo(e,e._tTime=e._tDur*a),e.parent&&Xo(e),n||Qi(e.parent,e),e},Sh=function(e){return e instanceof Kt?Qi(e):Yr(e,e._dur)},WM={_start:0,endTime:ws,totalDuration:ws},xn=function r(e,t,n){var i=e.labels,s=e._recent||WM,o=e.duration()>=An?s.endTime(!1):e._dur,a,c,l;return Ut(t)&&(isNaN(t)||t in i)?(c=t.charAt(0),l=t.substr(-1)==="%",a=t.indexOf("="),c==="<"||c===">"?(a>=0&&(t=t.replace(/=/,"")),(c==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(t.substr(1))||0)*(l?(a<0?s:n).totalDuration()/100:1)):a<0?(t in i||(i[t]=o),i[t]):(c=parseFloat(t.charAt(a-1)+t.substr(a+1)),l&&n&&(c=c/100*(Ht(n)?n[0]:n).totalDuration()),a>1?r(e,t.substr(0,a-1),n)+c:o+c)):t==null?o:+t},ys=function(e,t,n){var i=ai(t[1]),s=(i?2:1)+(e<2?0:1),o=t[s],a,c;if(i&&(o.duration=t[1]),o.parent=n,e){for(a=o,c=n;c&&!("immediateRender"in a);)a=c.vars.defaults||{},c=en(c.vars.inherit)&&c.parent;o.immediateRender=en(a.immediateRender),e<2?o.runBackwards=1:o.startAt=t[s-1]}return new Tt(t[0],o,t[s+1])},Ii=function(e,t){return e||e===0?t(e):t},Os=function(e,t,n){return n<e?e:n>t?t:n},Gt=function(e,t){return!Ut(e)||!(t=IM.exec(e))?"":t[1]},XM=function(e,t,n){return Ii(n,function(i){return Os(e,t,i)})},hc=[].slice,rd=function(e,t){return e&&Hn(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&Hn(e[0]))&&!e.nodeType&&e!==On},qM=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var s;return Ut(i)&&!t||rd(i,1)?(s=n).push.apply(s,wn(i)):n.push(i)})||n},wn=function(e,t,n){return at&&!t&&at.selector?at.selector(e):Ut(e)&&!n&&(ac||!jr())?hc.call((t||$c).querySelectorAll(e),0):Ht(e)?qM(e,n):rd(e)?hc.call(e,0):e?[e]:[]},fc=function(e){return e=wn(e)[0]||As("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return wn(t,n.querySelectorAll?n:n===e?As("Invalid scope")||$c.createElement("div"):e)}},sd=function(e){return e.sort(function(){return .5-Math.random()})},od=function(e){if(vt(e))return e;var t=Hn(e)?e:{each:e},n=er(t.ease),i=t.from||0,s=parseFloat(t.base)||0,o={},a=i>0&&i<1,c=isNaN(i)||a,l=t.axis,u=i,h=i;return Ut(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!a&&c&&(u=i[0],h=i[1]),function(f,d,_){var g=(_||t).length,m=o[g],p,v,x,M,A,E,T,C,y;if(!m){if(y=t.grid==="auto"?0:(t.grid||[1,An])[1],!y){for(T=-An;T<(T=_[y++].getBoundingClientRect().left)&&y<g;);y<g&&y--}for(m=o[g]=[],p=c?Math.min(y,g)*u-.5:i%y,v=y===An?0:c?g*h/y-.5:i/y|0,T=0,C=An,E=0;E<g;E++)x=E%y-p,M=v-(E/y|0),m[E]=A=l?Math.abs(l==="y"?M:x):Hf(x*x+M*M),A>T&&(T=A),A<C&&(C=A);i==="random"&&sd(m),m.max=T-C,m.min=C,m.v=g=(parseFloat(t.amount)||parseFloat(t.each)*(y>g?g-1:l?l==="y"?g/y:y:Math.max(y,g/y))||0)*(i==="edges"?-1:1),m.b=g<0?s-g:s,m.u=Gt(t.amount||t.each)||0,n=n&&g<0?gd(n):n}return g=(m[f]-m.min)/m.max||0,ft(m.b+(n?n(g):g)*m.v)+m.u}},dc=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=ft(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(ai(n)?0:Gt(n))}},ad=function(e,t){var n=Ht(e),i,s;return!n&&Hn(e)&&(i=n=e.radius||An,e.values?(e=wn(e.values),(s=!ai(e[0]))&&(i*=i)):e=dc(e.increment)),Ii(t,n?vt(e)?function(o){return s=e(o),Math.abs(s-o)<=i?s:o}:function(o){for(var a=parseFloat(s?o.x:o),c=parseFloat(s?o.y:0),l=An,u=0,h=e.length,f,d;h--;)s?(f=e[h].x-a,d=e[h].y-c,f=f*f+d*d):f=Math.abs(e[h]-a),f<l&&(l=f,u=h);return u=!i||l<=i?e[u]:o,s||u===o||ai(o)?u:u+Gt(o)}:dc(e))},cd=function(e,t,n,i){return Ii(Ht(e)?!t:n===!0?!!(n=0):!i,function(){return Ht(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},YM=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(s,o){return o(s)},i)}},jM=function(e,t){return function(n){return e(parseFloat(n))+(t||Gt(n))}},KM=function(e,t,n){return ud(e,t,0,1,n)},ld=function(e,t,n){return Ii(n,function(i){return e[~~t(i)]})},$M=function r(e,t,n){var i=t-e;return Ht(e)?ld(e,r(0,e.length),t):Ii(n,function(s){return(i+(s-e)%i)%i+e})},ZM=function r(e,t,n){var i=t-e,s=i*2;return Ht(e)?ld(e,r(0,e.length-1),t):Ii(n,function(o){return o=(s+(o-e)%s)%s||0,e+(o>i?s-o:o)})},Rs=function(e){return e.replace(PM,function(t){var n=t.indexOf("[")+1,i=t.substring(n||7,n?t.indexOf("]"):t.length-1).split(LM);return cd(n?i:+i[0],n?0:+i[1],+i[2]||1e-5)})},ud=function(e,t,n,i,s){var o=t-e,a=i-n;return Ii(s,function(c){return n+((c-e)/o*a||0)})},JM=function r(e,t,n,i){var s=isNaN(e+t)?0:function(d){return(1-d)*e+d*t};if(!s){var o=Ut(e),a={},c,l,u,h,f;if(n===!0&&(i=1)&&(n=null),o)e={p:e},t={p:t};else if(Ht(e)&&!Ht(t)){for(u=[],h=e.length,f=h-2,l=1;l<h;l++)u.push(r(e[l-1],e[l]));h--,s=function(_){_*=h;var g=Math.min(f,~~_);return u[g](_-g)},n=t}else i||(e=Xr(Ht(e)?[]:{},e));if(!u){for(c in t)nl.call(a,e,c,"get",t[c]);s=function(_){return ol(_,a)||(o?e.p:e)}}}return Ii(n,s)},Eh=function(e,t,n){var i=e.labels,s=An,o,a,c;for(o in i)a=i[o]-t,a<0==!!n&&a&&s>(a=Math.abs(a))&&(c=o,s=a);return c},hn=function(e,t,n){var i=e.vars,s=i[t],o=at,a=e._ctx,c,l,u;if(s)return c=i[t+"Params"],l=i.callbackScope||e,n&&wi.length&&Lo(),a&&(at=a),u=c?s.apply(l,c):s.call(l),at=o,u},fs=function(e){return Ci(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Nt),e.progress()<1&&hn(e,"onInterrupt"),e},Rr,hd=[],fd=function(e){if(e)if(e=!e.name&&e.default||e,Kc()||e.headless){var t=e.name,n=vt(e),i=t&&!n&&e.init?function(){this._props=[]}:e,s={init:ws,render:ol,add:nl,kill:pS,modifier:dS,rawVars:0},o={targetTest:0,get:0,getSetter:sl,aliases:{},register:0};if(jr(),e!==i){if(ln[t])return;mn(i,mn(Do(e,s),o)),Xr(i.prototype,Xr(s,Do(e,o))),ln[i.prop=t]=i,e.targetTest&&(yo.push(i),Jc[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}jf(t,i),e.register&&e.register(sn,i,nn)}else hd.push(e)},Qe=255,ds={aqua:[0,Qe,Qe],lime:[0,Qe,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Qe],navy:[0,0,128],white:[Qe,Qe,Qe],olive:[128,128,0],yellow:[Qe,Qe,0],orange:[Qe,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Qe,0,0],pink:[Qe,192,203],cyan:[0,Qe,Qe],transparent:[Qe,Qe,Qe,0]},Ba=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Qe+.5|0},dd=function(e,t,n){var i=e?ai(e)?[e>>16,e>>8&Qe,e&Qe]:0:ds.black,s,o,a,c,l,u,h,f,d,_;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),ds[e])i=ds[e];else if(e.charAt(0)==="#"){if(e.length<6&&(s=e.charAt(1),o=e.charAt(2),a=e.charAt(3),e="#"+s+s+o+o+a+a+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&Qe,i&Qe,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&Qe,e&Qe]}else if(e.substr(0,3)==="hsl"){if(i=_=e.match(xh),!t)c=+i[0]%360/360,l=+i[1]/100,u=+i[2]/100,o=u<=.5?u*(l+1):u+l-u*l,s=u*2-o,i.length>3&&(i[3]*=1),i[0]=Ba(c+1/3,s,o),i[1]=Ba(c,s,o),i[2]=Ba(c-1/3,s,o);else if(~e.indexOf("="))return i=e.match(Wf),n&&i.length<4&&(i[3]=1),i}else i=e.match(xh)||ds.transparent;i=i.map(Number)}return t&&!_&&(s=i[0]/Qe,o=i[1]/Qe,a=i[2]/Qe,h=Math.max(s,o,a),f=Math.min(s,o,a),u=(h+f)/2,h===f?c=l=0:(d=h-f,l=u>.5?d/(2-h-f):d/(h+f),c=h===s?(o-a)/d+(o<a?6:0):h===o?(a-s)/d+2:(s-o)/d+4,c*=60),i[0]=~~(c+.5),i[1]=~~(l*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},pd=function(e){var t=[],n=[],i=-1;return e.split(Ri).forEach(function(s){var o=s.match(wr)||[];t.push.apply(t,o),n.push(i+=o.length+1)}),t.c=n,t},Th=function(e,t,n){var i="",s=(e+i).match(Ri),o=t?"hsla(":"rgba(",a=0,c,l,u,h;if(!s)return e;if(s=s.map(function(f){return(f=dd(f,t,1))&&o+(t?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=pd(e),c=n.c,c.join(i)!==u.c.join(i)))for(l=e.replace(Ri,"1").split(wr),h=l.length-1;a<h;a++)i+=l[a]+(~c.indexOf(a)?s.shift()||o+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!l)for(l=e.split(Ri),h=l.length-1;a<h;a++)i+=l[a]+s[a];return i+l[h]},Ri=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in ds)r+="|"+e+"\\b";return new RegExp(r+")","gi")}(),QM=/hsl[a]?\(/,md=function(e){var t=e.join(" "),n;if(Ri.lastIndex=0,Ri.test(t))return n=QM.test(t),e[1]=Th(e[1],n),e[0]=Th(e[0],n,pd(e[1])),!0},Cs,un=function(){var r=Date.now,e=500,t=33,n=r(),i=n,s=1e3/240,o=s,a=[],c,l,u,h,f,d,_=function g(m){var p=r()-i,v=m===!0,x,M,A,E;if((p>e||p<0)&&(n+=p-t),i+=p,A=i-n,x=A-o,(x>0||v)&&(E=++h.frame,f=A-h.time*1e3,h.time=A=A/1e3,o+=x+(x>=s?4:s-x),M=1),v||(c=l(g)),M)for(d=0;d<a.length;d++)a[d](A,f,E,m)};return h={time:0,frame:0,tick:function(){_(!0)},deltaRatio:function(m){return f/(1e3/(m||60))},wake:function(){qf&&(!ac&&Kc()&&(On=ac=window,$c=On.document||{},pn.gsap=sn,(On.gsapVersions||(On.gsapVersions=[])).push(sn.version),Yf(Po||On.GreenSockGlobals||!On.gsap&&On||{}),hd.forEach(fd)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,c&&h.sleep(),l=u||function(m){return setTimeout(m,o-h.time*1e3+1|0)},Cs=1,_(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(c),Cs=0,l=ws},lagSmoothing:function(m,p){e=m||1/0,t=Math.min(p||33,e)},fps:function(m){s=1e3/(m||240),o=h.time*1e3+s},add:function(m,p,v){var x=p?function(M,A,E,T){m(M,A,E,T),h.remove(x)}:m;return h.remove(m),a[v?"unshift":"push"](x),jr(),x},remove:function(m,p){~(p=a.indexOf(m))&&a.splice(p,1)&&d>=p&&d--},_listeners:a},h}(),jr=function(){return!Cs&&un.wake()},Xe={},eS=/^[\d.\-M][\d.\-,\s]/,tS=/["']/g,nS=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],s=1,o=n.length,a,c,l;s<o;s++)c=n[s],a=s!==o-1?c.lastIndexOf(","):c.length,l=c.substr(0,a),t[i]=isNaN(l)?l.replace(tS,"").trim():+l,i=c.substr(a+1).trim();return t},iS=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},rS=function(e){var t=(e+"").split("("),n=Xe[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[nS(t[1])]:iS(e).split(",").map(Jf)):Xe._CE&&eS.test(e)?Xe._CE("",e):n},gd=function(e){return function(t){return 1-e(1-t)}},_d=function r(e,t){for(var n=e._first,i;n;)n instanceof Kt?r(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?r(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},er=function(e,t){return e&&(vt(e)?e:Xe[e]||rS(e))||t},sr=function(e,t,n,i){n===void 0&&(n=function(c){return 1-t(1-c)}),i===void 0&&(i=function(c){return c<.5?t(c*2)/2:1-t((1-c)*2)/2});var s={easeIn:t,easeOut:n,easeInOut:i},o;return tn(e,function(a){Xe[a]=pn[a]=s,Xe[o=a.toLowerCase()]=n;for(var c in s)Xe[o+(c==="easeIn"?".in":c==="easeOut"?".out":".inOut")]=Xe[a+"."+c]=s[c]}),s},xd=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},za=function r(e,t,n){var i=t>=1?t:1,s=(n||(e?.3:.45))/(t<1?t:1),o=s/oc*(Math.asin(1/i)||0),a=function(u){return u===1?1:i*Math.pow(2,-10*u)*CM((u-o)*s)+1},c=e==="out"?a:e==="in"?function(l){return 1-a(1-l)}:xd(a);return s=oc/s,c.config=function(l,u){return r(e,l,u)},c},ka=function r(e,t){t===void 0&&(t=1.70158);var n=function(o){return o?--o*o*((t+1)*o+t)+1:0},i=e==="out"?n:e==="in"?function(s){return 1-n(1-s)}:xd(n);return i.config=function(s){return r(e,s)},i};tn("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,e){var t=e<5?e+1:e;sr(r+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});Xe.Linear.easeNone=Xe.none=Xe.Linear.easeIn;sr("Elastic",za("in"),za("out"),za());(function(r,e){var t=1/e,n=2*t,i=2.5*t,s=function(a){return a<t?r*a*a:a<n?r*Math.pow(a-1.5/e,2)+.75:a<i?r*(a-=2.25/e)*a+.9375:r*Math.pow(a-2.625/e,2)+.984375};sr("Bounce",function(o){return 1-s(1-o)},s)})(7.5625,2.75);sr("Expo",function(r){return Math.pow(2,10*(r-1))*r+r*r*r*r*r*r*(1-r)});sr("Circ",function(r){return-(Hf(1-r*r)-1)});sr("Sine",function(r){return r===1?1:-RM(r*AM)+1});sr("Back",ka("in"),ka("out"),ka());Xe.SteppedEase=Xe.steps=pn.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),s=t?1:0,o=1-et;return function(a){return((i*Os(0,o,a)|0)+s)*n}}};Wr.ease=Xe["quad.out"];tn("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return Qc+=r+","+r+"Params,"});var vd=function(e,t){this.id=wM++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:$f,this.set=t?t.getSetter:sl},Ps=function(){function r(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,Yr(this,+t.duration,1,1),this.data=t.data,at&&(this._ctx=at,at.data.push(this)),Cs||un.wake()}var e=r.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,Yr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(jr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(qo(this,n),!s._dp||s.parent||td(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&kn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===et||!this._initted&&this._dur&&n||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Zf(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Mh(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Mh(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?qr(this._tTime,s)+1:1},e.timeScale=function(n,i){if(!arguments.length)return this._rts===-et?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Io(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-et?0:this._rts,this.totalTime(Os(-Math.abs(this._delay),this.totalDuration(),s),i!==!1),Xo(this),zM(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(jr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==et&&(this._tTime-=et)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=ft(n);var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&kn(i,this,this._start-this._delay),this}return this._start},e.endTime=function(n){return this._start+(en(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Io(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=NM);var i=Nt;return Nt=n,tl(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Nt=i,this},e.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Sh(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Sh(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(xn(this,n),en(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,en(i)),this._dur||(this._zTime=-et),this},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-et:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-et,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-et)},e.eventCallback=function(n,i,s){var o=this.vars;return arguments.length>1?(i?(o[n]=i,s&&(o[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete o[n],this):o[n]},e.then=function(n){var i=this,s=i._prom;return new Promise(function(o){var a=vt(n)?n:Qf,c=function(){var u=i.then;i.then=null,s&&s(),vt(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=u),o(a),i.then=u};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?c():i._prom=c})},e.kill=function(){fs(this)},r}();mn(Ps.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-et,_prom:0,_ps:!1,_rts:1});var Kt=function(r){Gf(e,r);function e(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=en(n.sortChildren),dt&&kn(n.parent||dt,Qn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&nd(Qn(s),n.scrollTrigger),s}var t=e.prototype;return t.to=function(i,s,o){return ys(0,arguments,this),this},t.from=function(i,s,o){return ys(1,arguments,this),this},t.fromTo=function(i,s,o,a){return ys(2,arguments,this),this},t.set=function(i,s,o){return s.duration=0,s.parent=this,vs(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new Tt(i,s,xn(this,o),1),this},t.call=function(i,s,o){return kn(this,Tt.delayedCall(0,i,s),o)},t.staggerTo=function(i,s,o,a,c,l,u){return o.duration=s,o.stagger=o.stagger||a,o.onComplete=l,o.onCompleteParams=u,o.parent=this,new Tt(i,o,xn(this,c)),this},t.staggerFrom=function(i,s,o,a,c,l,u){return o.runBackwards=1,vs(o).immediateRender=en(o.immediateRender),this.staggerTo(i,s,o,a,c,l,u)},t.staggerFromTo=function(i,s,o,a,c,l,u,h){return a.startAt=o,vs(a).immediateRender=en(a.immediateRender),this.staggerTo(i,s,a,c,l,u,h)},t.render=function(i,s,o){var a=this._time,c=this._dirty?this.totalDuration():this._tDur,l=this._dur,u=i<=0?0:ft(i),h=this._zTime<0!=i<0&&(this._initted||!l),f,d,_,g,m,p,v,x,M,A,E,T;if(this!==dt&&u>c&&i>=0&&(u=c),u!==this._tTime||o||h){if(a!==this._time&&l&&(u+=this._time-a,i+=this._time-a),f=u,M=this._start,x=this._ts,p=!x,h&&(l||(a=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(E=this._yoyo,m=l+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,o);if(f=ft(u%m),u===c?(g=this._repeat,f=l):(A=ft(u/m),g=~~A,g&&g===A&&(f=l,g--),f>l&&(f=l)),A=qr(this._tTime,m),!a&&this._tTime&&A!==g&&this._tTime-A*m-this._dur<=0&&(A=g),E&&g&1&&(f=l-f,T=1),g!==A&&!this._lock){var C=E&&A&1,y=C===(E&&g&1);if(g<A&&(C=!C),a=C?0:u%l?l:u,this._lock=1,this.render(a||(T?0:ft(g*m)),s,!l)._lock=0,this._tTime=u,!s&&this.parent&&hn(this,"onRepeat"),this.vars.repeatRefresh&&!T&&(this.invalidate()._lock=1,A=g),a&&a!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(l=this._dur,c=this._tDur,y&&(this._lock=2,a=C?l:-1e-4,this.render(a,!0),this.vars.repeatRefresh&&!T&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;_d(this,T)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(v=VM(this,ft(a),ft(f)),v&&(u-=f-(f=v._start))),this._tTime=u,this._time=f,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,a=0),!a&&u&&l&&!s&&!A&&(hn(this,"onStart"),this._tTime!==u))return this;if(f>=a&&i>=0)for(d=this._first;d;){if(_=d._next,(d._act||f>=d._start)&&d._ts&&v!==d){if(d.parent!==this)return this.render(i,s,o);if(d.render(d._ts>0?(f-d._start)*d._ts:(d._dirty?d.totalDuration():d._tDur)+(f-d._start)*d._ts,s,o),f!==this._time||!this._ts&&!p){v=0,_&&(u+=this._zTime=-et);break}}d=_}else{d=this._last;for(var b=i<0?i:f;d;){if(_=d._prev,(d._act||b<=d._end)&&d._ts&&v!==d){if(d.parent!==this)return this.render(i,s,o);if(d.render(d._ts>0?(b-d._start)*d._ts:(d._dirty?d.totalDuration():d._tDur)+(b-d._start)*d._ts,s,o||Nt&&tl(d)),f!==this._time||!this._ts&&!p){v=0,_&&(u+=this._zTime=b?-et:et);break}}d=_}}if(v&&!s&&(this.pause(),v.render(f>=a?0:-et)._zTime=f>=a?1:-1,this._ts))return this._start=M,Xo(this),this.render(i,s,o);this._onUpdate&&!s&&hn(this,"onUpdate",!0),(u===c&&this._tTime>=this.totalDuration()||!u&&a)&&(M===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!l)&&(u===c&&this._ts>0||!u&&this._ts<0)&&Ci(this,1),!s&&!(i<0&&!a)&&(u||a||!c)&&(hn(this,u===c&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<c&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,s){var o=this;if(ai(s)||(s=xn(this,s,i)),!(i instanceof Ps)){if(Ht(i))return i.forEach(function(a){return o.add(a,s)}),this;if(Ut(i))return this.addLabel(i,s);if(vt(i))i=Tt.delayedCall(0,i);else return this}return this!==i?kn(this,i,s):this},t.getChildren=function(i,s,o,a){i===void 0&&(i=!0),s===void 0&&(s=!0),o===void 0&&(o=!0),a===void 0&&(a=-An);for(var c=[],l=this._first;l;)l._start>=a&&(l instanceof Tt?s&&c.push(l):(o&&c.push(l),i&&c.push.apply(c,l.getChildren(!0,s,o)))),l=l._next;return c},t.getById=function(i){for(var s=this.getChildren(1,1,1),o=s.length;o--;)if(s[o].vars.id===i)return s[o]},t.remove=function(i){return Ut(i)?this.removeLabel(i):vt(i)?this.killTweensOf(i):(i.parent===this&&Wo(this,i),i===this._recent&&(this._recent=this._last),Qi(this))},t.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=ft(un.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},t.addLabel=function(i,s){return this.labels[i]=xn(this,s),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,s,o){var a=Tt.delayedCall(0,s||ws,o);return a.data="isPause",this._hasPause=1,kn(this,a,xn(this,i))},t.removePause=function(i){var s=this._first;for(i=xn(this,i);s;)s._start===i&&s.data==="isPause"&&Ci(s),s=s._next},t.killTweensOf=function(i,s,o){for(var a=this.getTweensOf(i,o),c=a.length;c--;)Mi!==a[c]&&a[c].kill(i,s);return this},t.getTweensOf=function(i,s){for(var o=[],a=wn(i),c=this._first,l=ai(s),u;c;)c instanceof Tt?OM(c._targets,a)&&(l?(!Mi||c._initted&&c._ts)&&c.globalTime(0)<=s&&c.globalTime(c.totalDuration())>s:!s||c.isActive())&&o.push(c):(u=c.getTweensOf(a,s)).length&&o.push.apply(o,u),c=c._next;return o},t.tweenTo=function(i,s){s=s||{};var o=this,a=xn(o,i),c=s,l=c.startAt,u=c.onStart,h=c.onStartParams,f=c.immediateRender,d,_=Tt.to(o,mn({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:a,overwrite:"auto",duration:s.duration||Math.abs((a-(l&&"time"in l?l.time:o._time))/o.timeScale())||et,onStart:function(){if(o.pause(),!d){var m=s.duration||Math.abs((a-(l&&"time"in l?l.time:o._time))/o.timeScale());_._dur!==m&&Yr(_,m,0,1).render(_._time,!0,!0),d=1}u&&u.apply(_,h||[])}},s));return f?_.render(0):_},t.tweenFromTo=function(i,s,o){return this.tweenTo(s,mn({startAt:{time:xn(this,i)}},o))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),Eh(this,xn(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),Eh(this,xn(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+et)},t.shiftChildren=function(i,s,o){o===void 0&&(o=0);var a=this._first,c=this.labels,l;for(i=ft(i);a;)a._start>=o&&(a._start+=i,a._end+=i),a=a._next;if(s)for(l in c)c[l]>=o&&(c[l]+=i);return Qi(this)},t.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,o;s;)o=s._next,this.remove(s),s=o;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Qi(this)},t.totalDuration=function(i){var s=0,o=this,a=o._last,c=An,l,u,h;if(arguments.length)return o.timeScale((o._repeat<0?o.duration():o.totalDuration())/(o.reversed()?-i:i));if(o._dirty){for(h=o.parent;a;)l=a._prev,a._dirty&&a.totalDuration(),u=a._start,u>c&&o._sort&&a._ts&&!o._lock?(o._lock=1,kn(o,a,u-a._delay,1)._lock=0):c=u,u<0&&a._ts&&(s-=u,(!h&&!o._dp||h&&h.smoothChildTiming)&&(o._start+=ft(u/o._ts),o._time-=u,o._tTime-=u),o.shiftChildren(-u,!1,-1/0),c=0),a._end>s&&a._ts&&(s=a._end),a=l;Yr(o,o===dt&&o._time>s?o._time:s,1,1),o._dirty=0}return o._tDur},e.updateRoot=function(i){if(dt._ts&&(Zf(dt,Io(i,dt)),Kf=un.frame),un.frame>=vh){vh+=dn.autoSleep||120;var s=dt._first;if((!s||!s._ts)&&dn.autoSleep&&un._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||un.sleep()}}},e}(Ps);mn(Kt.prototype,{_lock:0,_hasPause:0,_forcing:0});var sS=function(e,t,n,i,s,o,a){var c=new nn(this._pt,e,t,0,1,bd,null,s),l=0,u=0,h,f,d,_,g,m,p,v;for(c.b=n,c.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=Rs(i)),o&&(v=[n,i],o(v,e,t),n=v[0],i=v[1]),f=n.match(Oa)||[];h=Oa.exec(i);)_=h[0],g=i.substring(l,h.index),d?d=(d+1)%5:g.substr(-5)==="rgba("&&(d=1),_!==f[u++]&&(m=parseFloat(f[u-1])||0,c._pt={_next:c._pt,p:g||u===1?g:",",s:m,c:_.charAt(1)==="="?Dr(m,_)-m:parseFloat(_)-m,m:d&&d<4?Math.round:0},l=Oa.lastIndex);return c.c=l<i.length?i.substring(l,i.length):"",c.fp=a,(Xf.test(i)||p)&&(c.e=0),this._pt=c,c},nl=function(e,t,n,i,s,o,a,c,l,u){vt(i)&&(i=i(s||0,e,o));var h=e[t],f=n!=="get"?n:vt(h)?l?e[t.indexOf("set")||!vt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](l):e[t]():h,d=vt(h)?l?uS:Ed:rl,_;if(Ut(i)&&(~i.indexOf("random(")&&(i=Rs(i)),i.charAt(1)==="="&&(_=Dr(f,i)+(Gt(f)||0),(_||_===0)&&(i=_))),!u||f!==i||pc)return!isNaN(f*i)&&i!==""?(_=new nn(this._pt,e,t,+f||0,i-(f||0),typeof h=="boolean"?fS:Td,0,d),l&&(_.fp=l),a&&_.modifier(a,this,e),this._pt=_):(!h&&!(t in e)&&Zc(t,i),sS.call(this,e,t,f,i,d,c||dn.stringFilter,l))},oS=function(e,t,n,i,s){if(vt(e)&&(e=Ms(e,s,t,n,i)),!Hn(e)||e.style&&e.nodeType||Ht(e)||Vf(e))return Ut(e)?Ms(e,s,t,n,i):e;var o={},a;for(a in e)o[a]=Ms(e[a],s,t,n,i);return o},yd=function(e,t,n,i,s,o){var a,c,l,u;if(ln[e]&&(a=new ln[e]).init(s,a.rawVars?t[e]:oS(t[e],i,s,o,n),n,i,o)!==!1&&(n._pt=c=new nn(n._pt,s,e,0,1,a.render,a,0,a.priority),n!==Rr))for(l=n._ptLookup[n._targets.indexOf(s)],u=a._props.length;u--;)l[a._props[u]]=c;return a},Mi,pc,il=function r(e,t,n){var i=e.vars,s=i.ease,o=i.startAt,a=i.immediateRender,c=i.lazy,l=i.onUpdate,u=i.runBackwards,h=i.yoyoEase,f=i.keyframes,d=i.autoRevert,_=e._dur,g=e._startAt,m=e._targets,p=e.parent,v=p&&p.data==="nested"?p.vars.targets:m,x=e._overwrite==="auto"&&!Yc,M=e.timeline,A,E,T,C,y,b,N,O,q,P,U,F,W;if(M&&(!f||!s)&&(s="none"),e._ease=er(s,Wr.ease),e._yEase=h?gd(er(h===!0?s:h,Wr.ease)):0,h&&e._yoyo&&!e._repeat&&(h=e._yEase,e._yEase=e._ease,e._ease=h),e._from=!M&&!!i.runBackwards,!M||f&&!i.stagger){if(O=m[0]?Ji(m[0]).harness:0,F=O&&i[O.prop],A=Do(i,Jc),g&&(g._zTime<0&&g.progress(1),t<0&&u&&a&&!d?g.render(-1,!0):g.revert(u&&_?vo:UM),g._lazy=0),o){if(Ci(e._startAt=Tt.set(m,mn({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!g&&en(c),startAt:null,delay:0,onUpdate:l&&function(){return hn(e,"onUpdate")},stagger:0},o))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Nt||!a&&!d)&&e._startAt.revert(vo),a&&_&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(u&&_&&!g){if(t&&(a=!1),T=mn({overwrite:!1,data:"isFromStart",lazy:a&&!g&&en(c),immediateRender:a,stagger:0,parent:p},A),F&&(T[O.prop]=F),Ci(e._startAt=Tt.set(m,T)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Nt?e._startAt.revert(vo):e._startAt.render(-1,!0)),e._zTime=t,!a)r(e._startAt,et,et);else if(!t)return}for(e._pt=e._ptCache=0,c=_&&en(c)||c&&!_,E=0;E<m.length;E++){if(y=m[E],N=y._gsap||el(m)[E]._gsap,e._ptLookup[E]=P={},cc[N.id]&&wi.length&&Lo(),U=v===m?E:v.indexOf(y),O&&(q=new O).init(y,F||A,e,U,v)!==!1&&(e._pt=C=new nn(e._pt,y,q.name,0,1,q.render,q,0,q.priority),q._props.forEach(function(X){P[X]=C}),q.priority&&(b=1)),!O||F)for(T in A)ln[T]&&(q=yd(T,A,e,U,y,v))?q.priority&&(b=1):P[T]=C=nl.call(e,y,T,"get",A[T],U,v,0,i.stringFilter);e._op&&e._op[E]&&e.kill(y,e._op[E]),x&&e._pt&&(Mi=e,dt.killTweensOf(y,P,e.globalTime(t)),W=!e.parent,Mi=0),e._pt&&c&&(cc[N.id]=1)}b&&Ad(e),e._onInit&&e._onInit(e)}e._onUpdate=l,e._initted=(!e._op||e._pt)&&!W,f&&t<=0&&M.render(An,!0,!0)},aS=function(e,t,n,i,s,o,a,c){var l=(e._pt&&e._ptCache||(e._ptCache={}))[t],u,h,f,d;if(!l)for(l=e._ptCache[t]=[],f=e._ptLookup,d=e._targets.length;d--;){if(u=f[d][t],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==t&&u.fp!==t;)u=u._next;if(!u)return pc=1,e.vars[t]="+=0",il(e,a),pc=0,c?As(t+" not eligible for reset"):1;l.push(u)}for(d=l.length;d--;)h=l[d],u=h._pt||h,u.s=(i||i===0)&&!s?i:u.s+(i||0)+o*u.c,u.c=n-u.s,h.e&&(h.e=Mt(n)+Gt(h.e)),h.b&&(h.b=u.s+Gt(h.b))},cS=function(e,t){var n=e[0]?Ji(e[0]).harness:0,i=n&&n.aliases,s,o,a,c;if(!i)return t;s=Xr({},t);for(o in i)if(o in s)for(c=i[o].split(","),a=c.length;a--;)s[c[a]]=s[o];return s},lS=function(e,t,n,i){var s=t.ease||i||"power1.inOut",o,a;if(Ht(t))a=n[e]||(n[e]=[]),t.forEach(function(c,l){return a.push({t:l/(t.length-1)*100,v:c,e:s})});else for(o in t)a=n[o]||(n[o]=[]),o==="ease"||a.push({t:parseFloat(e),v:t[o],e:s})},Ms=function(e,t,n,i,s){return vt(e)?e.call(t,n,i,s):Ut(e)&&~e.indexOf("random(")?Rs(e):e},Md=Qc+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Sd={};tn(Md+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return Sd[r]=1});var Tt=function(r){Gf(e,r);function e(n,i,s,o){var a;typeof i=="number"&&(s.duration=i,i=s,s=null),a=r.call(this,o?i:vs(i))||this;var c=a.vars,l=c.duration,u=c.delay,h=c.immediateRender,f=c.stagger,d=c.overwrite,_=c.keyframes,g=c.defaults,m=c.scrollTrigger,p=c.yoyoEase,v=i.parent||dt,x=(Ht(n)||Vf(n)?ai(n[0]):"length"in i)?[n]:wn(n),M,A,E,T,C,y,b,N;if(a._targets=x.length?el(x):As("GSAP target "+n+" not found. https://gsap.com",!dn.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=d,_||f||go(l)||go(u)){if(i=a.vars,M=a.timeline=new Kt({data:"nested",defaults:g||{},targets:v&&v.data==="nested"?v.vars.targets:x}),M.kill(),M.parent=M._dp=Qn(a),M._start=0,f||go(l)||go(u)){if(T=x.length,b=f&&od(f),Hn(f))for(C in f)~Md.indexOf(C)&&(N||(N={}),N[C]=f[C]);for(A=0;A<T;A++)E=Do(i,Sd),E.stagger=0,p&&(E.yoyoEase=p),N&&Xr(E,N),y=x[A],E.duration=+Ms(l,Qn(a),A,y,x),E.delay=(+Ms(u,Qn(a),A,y,x)||0)-a._delay,!f&&T===1&&E.delay&&(a._delay=u=E.delay,a._start+=u,E.delay=0),M.to(y,E,b?b(A,y,x):0),M._ease=Xe.none;M.duration()?l=u=0:a.timeline=0}else if(_){vs(mn(M.vars.defaults,{ease:"none"})),M._ease=er(_.ease||i.ease||"none");var O=0,q,P,U;if(Ht(_))_.forEach(function(F){return M.to(x,F,">")}),M.duration();else{E={};for(C in _)C==="ease"||C==="easeEach"||lS(C,_[C],E,_.easeEach);for(C in E)for(q=E[C].sort(function(F,W){return F.t-W.t}),O=0,A=0;A<q.length;A++)P=q[A],U={ease:P.e,duration:(P.t-(A?q[A-1].t:0))/100*l},U[C]=P.v,M.to(x,U,O),O+=U.duration;M.duration()<l&&M.to({},{duration:l-M.duration()})}}l||a.duration(l=M.duration())}else a.timeline=0;return d===!0&&!Yc&&(Mi=Qn(a),dt.killTweensOf(x),Mi=0),kn(v,Qn(a),s),i.reversed&&a.reverse(),i.paused&&a.paused(!0),(h||!l&&!_&&a._start===ft(v._time)&&en(h)&&kM(Qn(a))&&v.data!=="nested")&&(a._tTime=-et,a.render(Math.max(0,-u)||0)),m&&nd(Qn(a),m),a}var t=e.prototype;return t.render=function(i,s,o){var a=this._time,c=this._tDur,l=this._dur,u=i<0,h=i>c-et&&!u?c:i<et?0:i,f,d,_,g,m,p,v,x,M;if(!l)HM(this,i,s,o);else if(h!==this._tTime||!i||o||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(f=h,x=this.timeline,this._repeat){if(g=l+this._rDelay,this._repeat<-1&&u)return this.totalTime(g*100+i,s,o);if(f=ft(h%g),h===c?(_=this._repeat,f=l):(m=ft(h/g),_=~~m,_&&_===m?(f=l,_--):f>l&&(f=l)),p=this._yoyo&&_&1,p&&(M=this._yEase,f=l-f),m=qr(this._tTime,g),f===a&&!o&&this._initted&&_===m)return this._tTime=h,this;_!==m&&(x&&this._yEase&&_d(x,p),this.vars.repeatRefresh&&!p&&!this._lock&&f!==g&&this._initted&&(this._lock=o=1,this.render(ft(g*_),!0).invalidate()._lock=0))}if(!this._initted){if(id(this,u?i:f,o,s,h))return this._tTime=0,this;if(a!==this._time&&!(o&&this.vars.repeatRefresh&&_!==m))return this;if(l!==this._dur)return this.render(i,s,o)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=v=(M||this._ease)(f/l),this._from&&(this.ratio=v=1-v),!a&&h&&!s&&!m&&(hn(this,"onStart"),this._tTime!==h))return this;for(d=this._pt;d;)d.r(v,d.d),d=d._next;x&&x.render(i<0?i:x._dur*x._ease(f/this._dur),s,o)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&lc(this,i,s,o),hn(this,"onUpdate")),this._repeat&&_!==m&&this.vars.onRepeat&&!s&&this.parent&&hn(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&lc(this,i,!0,!0),(i||!l)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&Ci(this,1),!s&&!(u&&!a)&&(h||a||p)&&(hn(this,h===c?"onComplete":"onReverseComplete",!0),this._prom&&!(h<c&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},t.resetTo=function(i,s,o,a,c){Cs||un.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||il(this,l),u=this._ease(l/this._dur),aS(this,i,s,o,a,u,l,c)?this.resetTo(i,s,o,a,1):(qo(this,0),this.parent||ed(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?fs(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Nt),this;if(this.timeline){var o=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Mi&&Mi.vars.overwrite!==!0)._first||fs(this),this.parent&&o!==this.timeline.totalDuration()&&Yr(this,this._dur*this.timeline._tDur/o,0,1),this}var a=this._targets,c=i?wn(i):a,l=this._ptLookup,u=this._pt,h,f,d,_,g,m,p;if((!s||s==="all")&&BM(a,c))return s==="all"&&(this._pt=0),fs(this);for(h=this._op=this._op||[],s!=="all"&&(Ut(s)&&(g={},tn(s,function(v){return g[v]=1}),s=g),s=cS(a,s)),p=a.length;p--;)if(~c.indexOf(a[p])){f=l[p],s==="all"?(h[p]=s,_=f,d={}):(d=h[p]=h[p]||{},_=s);for(g in _)m=f&&f[g],m&&((!("kill"in m.d)||m.d.kill(g)===!0)&&Wo(this,m,"_pt"),delete f[g]),d!=="all"&&(d[g]=1)}return this._initted&&!this._pt&&u&&fs(this),this},e.to=function(i,s){return new e(i,s,arguments[2])},e.from=function(i,s){return ys(1,arguments)},e.delayedCall=function(i,s,o,a){return new e(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:o,onReverseCompleteParams:o,callbackScope:a})},e.fromTo=function(i,s,o){return ys(2,arguments)},e.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new e(i,s)},e.killTweensOf=function(i,s,o){return dt.killTweensOf(i,s,o)},e}(Ps);mn(Tt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});tn("staggerTo,staggerFrom,staggerFromTo",function(r){Tt[r]=function(){var e=new Kt,t=hc.call(arguments,0);return t.splice(r==="staggerFromTo"?5:4,0,0),e[r].apply(e,t)}});var rl=function(e,t,n){return e[t]=n},Ed=function(e,t,n){return e[t](n)},uS=function(e,t,n,i){return e[t](i.fp,n)},hS=function(e,t,n){return e.setAttribute(t,n)},sl=function(e,t){return vt(e[t])?Ed:jc(e[t])&&e.setAttribute?hS:rl},Td=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},fS=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},bd=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},ol=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},dS=function(e,t,n,i){for(var s=this._pt,o;s;)o=s._next,s.p===i&&s.modifier(e,t,n),s=o},pS=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?Wo(this,t,"_pt"):t.dep||(n=1),t=i;return!n},mS=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},Ad=function(e){for(var t=e._pt,n,i,s,o;t;){for(n=t._next,i=s;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:o)?t._prev._next=t:s=t,(t._next=i)?i._prev=t:o=t,t=n}e._pt=s},nn=function(){function r(t,n,i,s,o,a,c,l,u){this.t=n,this.s=s,this.c=o,this.p=i,this.r=a||Td,this.d=c||this,this.set=l||rl,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=r.prototype;return e.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=mS,this.m=n,this.mt=s,this.tween=i},r}();tn(Qc+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return Jc[r]=1});pn.TweenMax=pn.TweenLite=Tt;pn.TimelineLite=pn.TimelineMax=Kt;dt=new Kt({sortChildren:!1,defaults:Wr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});dn.stringFilter=md;var tr=[],Mo={},gS=[],bh=0,_S=0,Ga=function(e){return(Mo[e]||gS).map(function(t){return t()})},mc=function(){var e=Date.now(),t=[];e-bh>2&&(Ga("matchMediaInit"),tr.forEach(function(n){var i=n.queries,s=n.conditions,o,a,c,l;for(a in i)o=On.matchMedia(i[a]).matches,o&&(c=1),o!==s[a]&&(s[a]=o,l=1);l&&(n.revert(),c&&t.push(n))}),Ga("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),bh=e,Ga("matchMedia"))},wd=function(){function r(t,n){this.selector=n&&fc(n),this.data=[],this._r=[],this.isReverted=!1,this.id=_S++,t&&this.add(t)}var e=r.prototype;return e.add=function(n,i,s){vt(n)&&(s=i,i=n,n=vt);var o=this,a=function(){var l=at,u=o.selector,h;return l&&l!==o&&l.data.push(o),s&&(o.selector=fc(s)),at=o,h=i.apply(o,arguments),vt(h)&&o._r.push(h),at=l,o.selector=u,o.isReverted=!1,h};return o.last=a,n===vt?a(o,function(c){return o.add(null,c)}):n?o[n]=a:a},e.ignore=function(n){var i=at;at=null,n(this),at=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof Tt&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var s=this;if(n?function(){for(var a=s.getTweens(),c=s.data.length,l;c--;)l=s.data[c],l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(u){return a.splice(a.indexOf(u),1)}));for(a.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),c=s.data.length;c--;)l=s.data[c],l instanceof Kt?l.data!=="nested"&&(l.scrollTrigger&&l.scrollTrigger.revert(),l.kill()):!(l instanceof Tt)&&l.revert&&l.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0}():this.data.forEach(function(a){return a.kill&&a.kill()}),this.clear(),i)for(var o=tr.length;o--;)tr[o].id===this.id&&tr.splice(o,1)},e.revert=function(n){this.kill(n||{})},r}(),xS=function(){function r(t){this.contexts=[],this.scope=t,at&&at.data.push(this)}var e=r.prototype;return e.add=function(n,i,s){Hn(n)||(n={matches:n});var o=new wd(0,s||this.scope),a=o.conditions={},c,l,u;at&&!o.selector&&(o.selector=at.selector),this.contexts.push(o),i=o.add("onMatch",i),o.queries=n;for(l in n)l==="all"?u=1:(c=On.matchMedia(n[l]),c&&(tr.indexOf(o)<0&&tr.push(o),(a[l]=c.matches)&&(u=1),c.addListener?c.addListener(mc):c.addEventListener("change",mc)));return u&&i(o,function(h){return o.add(null,h)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),Uo={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return fd(i)})},timeline:function(e){return new Kt(e)},getTweensOf:function(e,t){return dt.getTweensOf(e,t)},getProperty:function(e,t,n,i){Ut(e)&&(e=wn(e)[0]);var s=Ji(e||{}).get,o=n?Qf:Jf;return n==="native"&&(n=""),e&&(t?o((ln[t]&&ln[t].get||s)(e,t,n,i)):function(a,c,l){return o((ln[a]&&ln[a].get||s)(e,a,c,l))})},quickSetter:function(e,t,n){if(e=wn(e),e.length>1){var i=e.map(function(u){return sn.quickSetter(u,t,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}e=e[0]||{};var o=ln[t],a=Ji(e),c=a.harness&&(a.harness.aliases||{})[t]||t,l=o?function(u){var h=new o;Rr._pt=0,h.init(e,n?u+n:u,Rr,0,[e]),h.render(1,h),Rr._pt&&ol(1,Rr)}:a.set(e,c);return o?l:function(u){return l(e,c,n?u+n:u,a,1)}},quickTo:function(e,t,n){var i,s=sn.to(e,mn((i={},i[t]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),o=function(c,l,u){return s.resetTo(t,c,l,u)};return o.tween=s,o},isTweening:function(e){return dt.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=er(e.ease,Wr.ease)),yh(Wr,e||{})},config:function(e){return yh(dn,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,s=e.defaults,o=e.extendTimeline;(i||"").split(",").forEach(function(a){return a&&!ln[a]&&!pn[a]&&As(t+" effect requires "+a+" plugin.")}),Fa[t]=function(a,c,l){return n(wn(a),mn(c||{},s),l)},o&&(Kt.prototype[t]=function(a,c,l){return this.add(Fa[t](a,Hn(c)?c:(l=c)&&{},this),l)})},registerEase:function(e,t){Xe[e]=er(t)},parseEase:function(e,t){return arguments.length?er(e,t):Xe},getById:function(e){return dt.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Kt(e),i,s;for(n.smoothChildTiming=en(e.smoothChildTiming),dt.remove(n),n._dp=0,n._time=n._tTime=dt._time,i=dt._first;i;)s=i._next,(t||!(!i._dur&&i instanceof Tt&&i.vars.onComplete===i._targets[0]))&&kn(n,i,i._start-i._delay),i=s;return kn(dt,n,0),n},context:function(e,t){return e?new wd(e,t):at},matchMedia:function(e){return new xS(e)},matchMediaRefresh:function(){return tr.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||mc()},addEventListener:function(e,t){var n=Mo[e]||(Mo[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Mo[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:$M,wrapYoyo:ZM,distribute:od,random:cd,snap:ad,normalize:KM,getUnit:Gt,clamp:XM,splitColor:dd,toArray:wn,selector:fc,mapRange:ud,pipe:YM,unitize:jM,interpolate:JM,shuffle:sd},install:Yf,effects:Fa,ticker:un,updateRoot:Kt.updateRoot,plugins:ln,globalTimeline:dt,core:{PropTween:nn,globals:jf,Tween:Tt,Timeline:Kt,Animation:Ps,getCache:Ji,_removeLinkedListItem:Wo,reverting:function(){return Nt},context:function(e){return e&&at&&(at.data.push(e),e._ctx=at),at},suppressOverwrites:function(e){return Yc=e}}};tn("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Uo[r]=Tt[r]});un.add(Kt.updateRoot);Rr=Uo.to({},{duration:0});var vS=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},yS=function(e,t){var n=e._targets,i,s,o;for(i in t)for(s=n.length;s--;)o=e._ptLookup[s][i],o&&(o=o.d)&&(o._pt&&(o=vS(o,i)),o&&o.modifier&&o.modifier(t[i],e,n[s],i))},Ha=function(e,t){return{name:e,headless:1,rawVars:1,init:function(i,s,o){o._onInit=function(a){var c,l;if(Ut(s)&&(c={},tn(s,function(u){return c[u]=1}),s=c),t){c={};for(l in s)c[l]=t(s[l]);s=c}yS(a,s)}}}},sn=Uo.registerPlugin({name:"attr",init:function(e,t,n,i,s){var o,a,c;this.tween=n;for(o in t)c=e.getAttribute(o)||"",a=this.add(e,"setAttribute",(c||0)+"",t[o],i,s,0,0,o),a.op=o,a.b=c,this._props.push(o)},render:function(e,t){for(var n=t._pt;n;)Nt?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Ha("roundProps",dc),Ha("modifiers"),Ha("snap",ad))||Uo;Tt.version=Kt.version=sn.version="3.14.2";qf=1;Kc()&&jr();Xe.Power0;Xe.Power1;Xe.Power2;Xe.Power3;Xe.Power4;Xe.Linear;Xe.Quad;Xe.Cubic;Xe.Quart;Xe.Quint;Xe.Strong;Xe.Elastic;Xe.Back;Xe.SteppedEase;Xe.Bounce;Xe.Sine;Xe.Expo;Xe.Circ;/*!
 * CSSPlugin 3.14.2
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Ah,Si,Ir,al,ji,wh,cl,MS=function(){return typeof window<"u"},ci={},Wi=180/Math.PI,Ur=Math.PI/180,Er=Math.atan2,Rh=1e8,ll=/([A-Z])/g,SS=/(left|right|width|margin|padding|x)/i,ES=/[\s,\(]\S/,Gn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},gc=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},TS=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},bS=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},AS=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},wS=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Rd=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Cd=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},RS=function(e,t,n){return e.style[t]=n},CS=function(e,t,n){return e.style.setProperty(t,n)},PS=function(e,t,n){return e._gsap[t]=n},LS=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},DS=function(e,t,n,i,s){var o=e._gsap;o.scaleX=o.scaleY=n,o.renderTransform(s,o)},IS=function(e,t,n,i,s){var o=e._gsap;o[t]=n,o.renderTransform(s,o)},mt="transform",rn=mt+"Origin",US=function r(e,t){var n=this,i=this.target,s=i.style,o=i._gsap;if(e in ci&&s){if(this.tfm=this.tfm||{},e!=="transform")e=Gn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=ei(i,a)}):this.tfm[e]=o.x?o[e]:ei(i,e),e===rn&&(this.tfm.zOrigin=o.zOrigin);else return Gn.transform.split(",").forEach(function(a){return r.call(n,a,t)});if(this.props.indexOf(mt)>=0)return;o.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(rn,t,"")),e=mt}(s||t)&&this.props.push(e,t,s[e])},Pd=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},NS=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,o;for(s=0;s<e.length;s+=3)e[s+1]?e[s+1]===2?t[e[s]](e[s+2]):t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(ll,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)i[o]=this.tfm[o];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=cl(),(!s||!s.isStart)&&!n[mt]&&(Pd(n),i.zOrigin&&n[rn]&&(n[rn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Ld=function(e,t){var n={target:e,props:[],revert:NS,save:US};return e._gsap||sn.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},Dd,_c=function(e,t){var n=Si.createElementNS?Si.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Si.createElement(e);return n&&n.style?n:Si.createElement(e)},fn=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(ll,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,Kr(t)||t,1)||""},Ch="O,Moz,ms,Ms,Webkit".split(","),Kr=function(e,t,n){var i=t||ji,s=i.style,o=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);o--&&!(Ch[o]+e in s););return o<0?null:(o===3?"ms":o>=0?Ch[o]:"")+e},xc=function(){MS()&&window.document&&(Ah=window,Si=Ah.document,Ir=Si.documentElement,ji=_c("div")||{style:{}},_c("div"),mt=Kr(mt),rn=mt+"Origin",ji.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Dd=!!Kr("perspective"),cl=sn.core.reverting,al=1)},Ph=function(e){var t=e.ownerSVGElement,n=_c("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),s;i.style.display="block",n.appendChild(i),Ir.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),Ir.removeChild(n),s},Lh=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Id=function(e){var t,n;try{t=e.getBBox()}catch{t=Ph(e),n=1}return t&&(t.width||t.height)||n||(t=Ph(e)),t&&!t.width&&!t.x&&!t.y?{x:+Lh(e,["x","cx","x1"])||0,y:+Lh(e,["y","cy","y1"])||0,width:0,height:0}:t},Ud=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Id(e))},Pi=function(e,t){if(t){var n=e.style,i;t in ci&&t!==rn&&(t=mt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(ll,"-$1").toLowerCase())):n.removeAttribute(t)}},Ei=function(e,t,n,i,s,o){var a=new nn(e._pt,t,n,0,1,o?Cd:Rd);return e._pt=a,a.b=i,a.e=s,e._props.push(n),a},Dh={deg:1,rad:1,turn:1},OS={grid:1,flex:1},Li=function r(e,t,n,i){var s=parseFloat(n)||0,o=(n+"").trim().substr((s+"").length)||"px",a=ji.style,c=SS.test(t),l=e.tagName.toLowerCase()==="svg",u=(l?"client":"offset")+(c?"Width":"Height"),h=100,f=i==="px",d=i==="%",_,g,m,p;if(i===o||!s||Dh[i]||Dh[o])return s;if(o!=="px"&&!f&&(s=r(e,t,n,"px")),p=e.getCTM&&Ud(e),(d||o==="%")&&(ci[t]||~t.indexOf("adius")))return _=p?e.getBBox()[c?"width":"height"]:e[u],Mt(d?s/_*h:s/100*_);if(a[c?"width":"height"]=h+(f?o:i),g=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!l?e:e.parentNode,p&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===Si||!g.appendChild)&&(g=Si.body),m=g._gsap,m&&d&&m.width&&c&&m.time===un.time&&!m.uncache)return Mt(s/m.width*h);if(d&&(t==="height"||t==="width")){var v=e.style[t];e.style[t]=h+i,_=e[u],v?e.style[t]=v:Pi(e,t)}else(d||o==="%")&&!OS[fn(g,"display")]&&(a.position=fn(e,"position")),g===e&&(a.position="static"),g.appendChild(ji),_=ji[u],g.removeChild(ji),a.position="absolute";return c&&d&&(m=Ji(g),m.time=un.time,m.width=g[u]),Mt(f?_*s/h:_&&s?h/_*s:0)},ei=function(e,t,n,i){var s;return al||xc(),t in Gn&&t!=="transform"&&(t=Gn[t],~t.indexOf(",")&&(t=t.split(",")[0])),ci[t]&&t!=="transform"?(s=Ds(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:Oo(fn(e,rn))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=No[t]&&No[t](e,t,n)||fn(e,t)||$f(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Li(e,t,s,n)+n:s},FS=function(e,t,n,i){if(!n||n==="none"){var s=Kr(t,e,1),o=s&&fn(e,s,1);o&&o!==n?(t=s,n=o):t==="borderColor"&&(n=fn(e,"borderTopColor"))}var a=new nn(this._pt,e.style,t,0,1,bd),c=0,l=0,u,h,f,d,_,g,m,p,v,x,M,A;if(a.b=n,a.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=fn(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(g=e.style[t],e.style[t]=i,i=fn(e,t)||i,g?e.style[t]=g:Pi(e,t)),u=[n,i],md(u),n=u[0],i=u[1],f=n.match(wr)||[],A=i.match(wr)||[],A.length){for(;h=wr.exec(i);)m=h[0],v=i.substring(c,h.index),_?_=(_+1)%5:(v.substr(-5)==="rgba("||v.substr(-5)==="hsla(")&&(_=1),m!==(g=f[l++]||"")&&(d=parseFloat(g)||0,M=g.substr((d+"").length),m.charAt(1)==="="&&(m=Dr(d,m)+M),p=parseFloat(m),x=m.substr((p+"").length),c=wr.lastIndex-x.length,x||(x=x||dn.units[t]||M,c===i.length&&(i+=x,a.e+=x)),M!==x&&(d=Li(e,t,g,x)||0),a._pt={_next:a._pt,p:v||l===1?v:",",s:d,c:p-d,m:_&&_<4||t==="zIndex"?Math.round:0});a.c=c<i.length?i.substring(c,i.length):""}else a.r=t==="display"&&i==="none"?Cd:Rd;return Xf.test(i)&&(a.e=0),this._pt=a,a},Ih={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},BS=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Ih[n]||n,t[1]=Ih[i]||i,t.join(" ")},zS=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,o=n._gsap,a,c,l;if(s==="all"||s===!0)i.cssText="",c=1;else for(s=s.split(","),l=s.length;--l>-1;)a=s[l],ci[a]&&(c=1,a=a==="transformOrigin"?rn:mt),Pi(n,a);c&&(Pi(n,mt),o&&(o.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Ds(n,1),o.uncache=1,Pd(i)))}},No={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var o=e._pt=new nn(e._pt,t,n,0,0,zS);return o.u=i,o.pr=-10,o.tween=s,e._props.push(n),1}}},Ls=[1,0,0,1,0,0],Nd={},Od=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Uh=function(e){var t=fn(e,mt);return Od(t)?Ls:t.substr(7).match(Wf).map(Mt)},ul=function(e,t){var n=e._gsap||Ji(e),i=e.style,s=Uh(e),o,a,c,l;return n.svg&&e.getAttribute("transform")?(c=e.transform.baseVal.consolidate().matrix,s=[c.a,c.b,c.c,c.d,c.e,c.f],s.join(",")==="1,0,0,1,0,0"?Ls:s):(s===Ls&&!e.offsetParent&&e!==Ir&&!n.svg&&(c=i.display,i.display="block",o=e.parentNode,(!o||!e.offsetParent&&!e.getBoundingClientRect().width)&&(l=1,a=e.nextElementSibling,Ir.appendChild(e)),s=Uh(e),c?i.display=c:Pi(e,"display"),l&&(a?o.insertBefore(e,a):o?o.appendChild(e):Ir.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},vc=function(e,t,n,i,s,o){var a=e._gsap,c=s||ul(e,!0),l=a.xOrigin||0,u=a.yOrigin||0,h=a.xOffset||0,f=a.yOffset||0,d=c[0],_=c[1],g=c[2],m=c[3],p=c[4],v=c[5],x=t.split(" "),M=parseFloat(x[0])||0,A=parseFloat(x[1])||0,E,T,C,y;n?c!==Ls&&(T=d*m-_*g)&&(C=M*(m/T)+A*(-g/T)+(g*v-m*p)/T,y=M*(-_/T)+A*(d/T)-(d*v-_*p)/T,M=C,A=y):(E=Id(e),M=E.x+(~x[0].indexOf("%")?M/100*E.width:M),A=E.y+(~(x[1]||x[0]).indexOf("%")?A/100*E.height:A)),i||i!==!1&&a.smooth?(p=M-l,v=A-u,a.xOffset=h+(p*d+v*g)-p,a.yOffset=f+(p*_+v*m)-v):a.xOffset=a.yOffset=0,a.xOrigin=M,a.yOrigin=A,a.smooth=!!i,a.origin=t,a.originIsAbsolute=!!n,e.style[rn]="0px 0px",o&&(Ei(o,a,"xOrigin",l,M),Ei(o,a,"yOrigin",u,A),Ei(o,a,"xOffset",h,a.xOffset),Ei(o,a,"yOffset",f,a.yOffset)),e.setAttribute("data-svg-origin",M+" "+A)},Ds=function(e,t){var n=e._gsap||new vd(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,o="px",a="deg",c=getComputedStyle(e),l=fn(e,rn)||"0",u,h,f,d,_,g,m,p,v,x,M,A,E,T,C,y,b,N,O,q,P,U,F,W,X,Y,K,ee,te,V,j,re;return u=h=f=g=m=p=v=x=M=0,d=_=1,n.svg=!!(e.getCTM&&Ud(e)),c.translate&&((c.translate!=="none"||c.scale!=="none"||c.rotate!=="none")&&(i[mt]=(c.translate!=="none"?"translate3d("+(c.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(c.rotate!=="none"?"rotate("+c.rotate+") ":"")+(c.scale!=="none"?"scale("+c.scale.split(" ").join(",")+") ":"")+(c[mt]!=="none"?c[mt]:"")),i.scale=i.rotate=i.translate="none"),T=ul(e,n.svg),n.svg&&(n.uncache?(X=e.getBBox(),l=n.xOrigin-X.x+"px "+(n.yOrigin-X.y)+"px",W=""):W=!t&&e.getAttribute("data-svg-origin"),vc(e,W||l,!!W||n.originIsAbsolute,n.smooth!==!1,T)),A=n.xOrigin||0,E=n.yOrigin||0,T!==Ls&&(N=T[0],O=T[1],q=T[2],P=T[3],u=U=T[4],h=F=T[5],T.length===6?(d=Math.sqrt(N*N+O*O),_=Math.sqrt(P*P+q*q),g=N||O?Er(O,N)*Wi:0,v=q||P?Er(q,P)*Wi+g:0,v&&(_*=Math.abs(Math.cos(v*Ur))),n.svg&&(u-=A-(A*N+E*q),h-=E-(A*O+E*P))):(re=T[6],V=T[7],K=T[8],ee=T[9],te=T[10],j=T[11],u=T[12],h=T[13],f=T[14],C=Er(re,te),m=C*Wi,C&&(y=Math.cos(-C),b=Math.sin(-C),W=U*y+K*b,X=F*y+ee*b,Y=re*y+te*b,K=U*-b+K*y,ee=F*-b+ee*y,te=re*-b+te*y,j=V*-b+j*y,U=W,F=X,re=Y),C=Er(-q,te),p=C*Wi,C&&(y=Math.cos(-C),b=Math.sin(-C),W=N*y-K*b,X=O*y-ee*b,Y=q*y-te*b,j=P*b+j*y,N=W,O=X,q=Y),C=Er(O,N),g=C*Wi,C&&(y=Math.cos(C),b=Math.sin(C),W=N*y+O*b,X=U*y+F*b,O=O*y-N*b,F=F*y-U*b,N=W,U=X),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,p=180-p),d=Mt(Math.sqrt(N*N+O*O+q*q)),_=Mt(Math.sqrt(F*F+re*re)),C=Er(U,F),v=Math.abs(C)>2e-4?C*Wi:0,M=j?1/(j<0?-j:j):0),n.svg&&(W=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Od(fn(e,mt)),W&&e.setAttribute("transform",W))),Math.abs(v)>90&&Math.abs(v)<270&&(s?(d*=-1,v+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,v+=v<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+o,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+o,n.z=f+o,n.scaleX=Mt(d),n.scaleY=Mt(_),n.rotation=Mt(g)+a,n.rotationX=Mt(m)+a,n.rotationY=Mt(p)+a,n.skewX=v+a,n.skewY=x+a,n.transformPerspective=M+o,(n.zOrigin=parseFloat(l.split(" ")[2])||!t&&n.zOrigin||0)&&(i[rn]=Oo(l)),n.xOffset=n.yOffset=0,n.force3D=dn.force3D,n.renderTransform=n.svg?GS:Dd?Fd:kS,n.uncache=0,n},Oo=function(e){return(e=e.split(" "))[0]+" "+e[1]},Va=function(e,t,n){var i=Gt(t);return Mt(parseFloat(t)+parseFloat(Li(e,"x",n+"px",i)))+i},kS=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Fd(e,t)},Gi="0deg",hs="0px",Hi=") ",Fd=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,c=n.z,l=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,d=n.skewY,_=n.scaleX,g=n.scaleY,m=n.transformPerspective,p=n.force3D,v=n.target,x=n.zOrigin,M="",A=p==="auto"&&e&&e!==1||p===!0;if(x&&(h!==Gi||u!==Gi)){var E=parseFloat(u)*Ur,T=Math.sin(E),C=Math.cos(E),y;E=parseFloat(h)*Ur,y=Math.cos(E),o=Va(v,o,T*y*-x),a=Va(v,a,-Math.sin(E)*-x),c=Va(v,c,C*y*-x+x)}m!==hs&&(M+="perspective("+m+Hi),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(A||o!==hs||a!==hs||c!==hs)&&(M+=c!==hs||A?"translate3d("+o+", "+a+", "+c+") ":"translate("+o+", "+a+Hi),l!==Gi&&(M+="rotate("+l+Hi),u!==Gi&&(M+="rotateY("+u+Hi),h!==Gi&&(M+="rotateX("+h+Hi),(f!==Gi||d!==Gi)&&(M+="skew("+f+", "+d+Hi),(_!==1||g!==1)&&(M+="scale("+_+", "+g+Hi),v.style[mt]=M||"translate(0, 0)"},GS=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,c=n.rotation,l=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,d=n.target,_=n.xOrigin,g=n.yOrigin,m=n.xOffset,p=n.yOffset,v=n.forceCSS,x=parseFloat(o),M=parseFloat(a),A,E,T,C,y;c=parseFloat(c),l=parseFloat(l),u=parseFloat(u),u&&(u=parseFloat(u),l+=u,c+=u),c||l?(c*=Ur,l*=Ur,A=Math.cos(c)*h,E=Math.sin(c)*h,T=Math.sin(c-l)*-f,C=Math.cos(c-l)*f,l&&(u*=Ur,y=Math.tan(l-u),y=Math.sqrt(1+y*y),T*=y,C*=y,u&&(y=Math.tan(u),y=Math.sqrt(1+y*y),A*=y,E*=y)),A=Mt(A),E=Mt(E),T=Mt(T),C=Mt(C)):(A=h,C=f,E=T=0),(x&&!~(o+"").indexOf("px")||M&&!~(a+"").indexOf("px"))&&(x=Li(d,"x",o,"px"),M=Li(d,"y",a,"px")),(_||g||m||p)&&(x=Mt(x+_-(_*A+g*T)+m),M=Mt(M+g-(_*E+g*C)+p)),(i||s)&&(y=d.getBBox(),x=Mt(x+i/100*y.width),M=Mt(M+s/100*y.height)),y="matrix("+A+","+E+","+T+","+C+","+x+","+M+")",d.setAttribute("transform",y),v&&(d.style[mt]=y)},HS=function(e,t,n,i,s){var o=360,a=Ut(s),c=parseFloat(s)*(a&&~s.indexOf("rad")?Wi:1),l=c-i,u=i+l+"deg",h,f;return a&&(h=s.split("_")[1],h==="short"&&(l%=o,l!==l%(o/2)&&(l+=l<0?o:-o)),h==="cw"&&l<0?l=(l+o*Rh)%o-~~(l/o)*o:h==="ccw"&&l>0&&(l=(l-o*Rh)%o-~~(l/o)*o)),e._pt=f=new nn(e._pt,t,n,i,l,TS),f.e=u,f.u="deg",e._props.push(n),f},Nh=function(e,t){for(var n in t)e[n]=t[n];return e},VS=function(e,t,n){var i=Nh({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",o=n.style,a,c,l,u,h,f,d,_;i.svg?(l=n.getAttribute("transform"),n.setAttribute("transform",""),o[mt]=t,a=Ds(n,1),Pi(n,mt),n.setAttribute("transform",l)):(l=getComputedStyle(n)[mt],o[mt]=t,a=Ds(n,1),o[mt]=l);for(c in ci)l=i[c],u=a[c],l!==u&&s.indexOf(c)<0&&(d=Gt(l),_=Gt(u),h=d!==_?Li(n,c,l,_):parseFloat(l),f=parseFloat(u),e._pt=new nn(e._pt,a,c,h,f-h,gc),e._pt.u=_||0,e._props.push(c));Nh(a,i)};tn("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",o=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(a){return e<2?r+a:"border"+a+r});No[e>1?"border"+r:r]=function(a,c,l,u,h){var f,d;if(arguments.length<4)return f=o.map(function(_){return ei(a,_,l)}),d=f.join(" "),d.split(f[0]).length===5?f[0]:d;f=(u+"").split(" "),d={},o.forEach(function(_,g){return d[_]=f[g]=f[g]||f[(g-1)/2|0]}),a.init(c,d,h)}});var Bd={name:"css",register:xc,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var o=this._props,a=e.style,c=n.vars.startAt,l,u,h,f,d,_,g,m,p,v,x,M,A,E,T,C,y;al||xc(),this.styles=this.styles||Ld(e),C=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(u=t[g],!(ln[g]&&yd(g,t,n,i,e,s)))){if(d=typeof u,_=No[g],d==="function"&&(u=u.call(n,i,e,s),d=typeof u),d==="string"&&~u.indexOf("random(")&&(u=Rs(u)),_)_(this,e,g,u,n)&&(T=1);else if(g.substr(0,2)==="--")l=(getComputedStyle(e).getPropertyValue(g)+"").trim(),u+="",Ri.lastIndex=0,Ri.test(l)||(m=Gt(l),p=Gt(u),p?m!==p&&(l=Li(e,g,l,p)+p):m&&(u+=m)),this.add(a,"setProperty",l,u,i,s,0,0,g),o.push(g),C.push(g,0,a[g]);else if(d!=="undefined"){if(c&&g in c?(l=typeof c[g]=="function"?c[g].call(n,i,e,s):c[g],Ut(l)&&~l.indexOf("random(")&&(l=Rs(l)),Gt(l+"")||l==="auto"||(l+=dn.units[g]||Gt(ei(e,g))||""),(l+"").charAt(1)==="="&&(l=ei(e,g))):l=ei(e,g),f=parseFloat(l),v=d==="string"&&u.charAt(1)==="="&&u.substr(0,2),v&&(u=u.substr(2)),h=parseFloat(u),g in Gn&&(g==="autoAlpha"&&(f===1&&ei(e,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,a.visibility),Ei(this,a,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),g!=="scale"&&g!=="transform"&&(g=Gn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),x=g in ci,x){if(this.styles.save(g),y=u,d==="string"&&u.substring(0,6)==="var(--"){if(u=fn(e,u.substring(4,u.indexOf(")"))),u.substring(0,5)==="calc("){var b=e.style.perspective;e.style.perspective=u,u=fn(e,"perspective"),b?e.style.perspective=b:Pi(e,"perspective")}h=parseFloat(u)}if(M||(A=e._gsap,A.renderTransform&&!t.parseTransform||Ds(e,t.parseTransform),E=t.smoothOrigin!==!1&&A.smooth,M=this._pt=new nn(this._pt,a,mt,0,1,A.renderTransform,A,0,-1),M.dep=1),g==="scale")this._pt=new nn(this._pt,A,"scaleY",A.scaleY,(v?Dr(A.scaleY,v+h):h)-A.scaleY||0,gc),this._pt.u=0,o.push("scaleY",g),g+="X";else if(g==="transformOrigin"){C.push(rn,0,a[rn]),u=BS(u),A.svg?vc(e,u,0,E,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==A.zOrigin&&Ei(this,A,"zOrigin",A.zOrigin,p),Ei(this,a,g,Oo(l),Oo(u)));continue}else if(g==="svgOrigin"){vc(e,u,1,E,0,this);continue}else if(g in Nd){HS(this,A,g,f,v?Dr(f,v+u):u);continue}else if(g==="smoothOrigin"){Ei(this,A,"smooth",A.smooth,u);continue}else if(g==="force3D"){A[g]=u;continue}else if(g==="transform"){VS(this,u,e);continue}}else g in a||(g=Kr(g)||g);if(x||(h||h===0)&&(f||f===0)&&!ES.test(u)&&g in a)m=(l+"").substr((f+"").length),h||(h=0),p=Gt(u)||(g in dn.units?dn.units[g]:m),m!==p&&(f=Li(e,g,l,p)),this._pt=new nn(this._pt,x?A:a,g,f,(v?Dr(f,v+h):h)-f,!x&&(p==="px"||g==="zIndex")&&t.autoRound!==!1?wS:gc),this._pt.u=p||0,x&&y!==u?(this._pt.b=l,this._pt.e=y,this._pt.r=AS):m!==p&&p!=="%"&&(this._pt.b=l,this._pt.r=bS);else if(g in a)FS.call(this,e,g,l,v?v+u:u);else if(g in e)this.add(e,g,l||e[g],v?v+u:u,i,s);else if(g!=="parseTransform"){Zc(g,u);continue}x||(g in a?C.push(g,0,a[g]):typeof e[g]=="function"?C.push(g,2,e[g]()):C.push(g,1,l||e[g])),o.push(g)}}T&&Ad(this)},render:function(e,t){if(t.tween._time||!cl())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:ei,aliases:Gn,getSetter:function(e,t,n){var i=Gn[t];return i&&i.indexOf(",")<0&&(t=i),t in ci&&t!==rn&&(e._gsap.x||ei(e,"x"))?n&&wh===n?t==="scale"?LS:PS:(wh=n||{})&&(t==="scale"?DS:IS):e.style&&!jc(e.style[t])?RS:~t.indexOf("-")?CS:sl(e,t)},core:{_removeProperty:Pi,_getMatrix:ul}};sn.utils.checkPrefix=Kr;sn.core.getStyleSaver=Ld;(function(r,e,t,n){var i=tn(r+","+e+","+t,function(s){ci[s]=1});tn(e,function(s){dn.units[s]="deg",Nd[s]=1}),Gn[i[13]]=r+","+e,tn(n,function(s){var o=s.split(":");Gn[o[1]]=i[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");tn("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){dn.units[r]="px"});sn.registerPlugin(Bd);var xt=sn.registerPlugin(Bd)||sn;xt.core.Tween;class WS{constructor(e){_e(this,"mesh");_e(this,"currentAnimation","idle");_e(this,"targetPosition",null);this.mesh=e.clone(),this.mesh.scale.set(.5,.5,.5),this.setupAnimations()}setupAnimations(){this.mesh.position.set(0,0,0),this.mesh.rotation.set(0,0,0)}getMesh(){return this.mesh}update(e){const t=kt.getState();if(t.dogTarget?this.targetPosition=new D(t.dogTarget.x,0,t.dogTarget.z):this.targetPosition=null,this.targetPosition){const n=new D().subVectors(this.targetPosition,this.mesh.position);n.y=0;const i=n.length();if(i>bn.dog.targetReachedThreshold){n.normalize();const s=bn.dog.moveSpeed*e;this.mesh.position.add(n.multiplyScalar(Math.min(s,i)));const o=Math.atan2(n.x,n.z);this.mesh.rotation.y=gs.lerp(this.mesh.rotation.y,o,bn.dog.rotationSpeed*e),t.setDogPosition({x:this.mesh.position.x,y:this.mesh.position.y,z:this.mesh.position.z}),t.setDogMoving(!0),this.currentAnimation!=="walk"&&this.playWalkAnimation()}else this.targetPosition=null,t.setDogTarget(null),t.setDogMoving(!1),this.currentAnimation!=="idle"&&!t.dogIsSniffing&&!t.dogIsDigging&&this.playIdleAnimation()}this.updateEmotionalVisual(t.dogEmotionalState)}updateEmotionalVisual(e){const t=this.mesh.children[1];switch(e){case Lt.CURIOUS:t.rotation.z=Math.sin(Date.now()*.005)*.1;break;case Lt.CONVINCED:t.rotation.z=Math.sin(Date.now()*.01)*.15;break;case Lt.ALMOST:this.mesh.position.y=Math.abs(Math.sin(Date.now()*.01))*.1;break;case Lt.CONFUSED:t.rotation.z=Math.sin(Date.now()*.02)*.2;break;case Lt.NEUTRAL:default:t.rotation.z=0;break}}playIdleAnimation(){this.currentAnimation="idle",xt.to(this.mesh.scale,{y:1.02,duration:1.5,ease:"sine.inOut",repeat:-1,yoyo:!0})}playWalkAnimation(){this.currentAnimation="walk",xt.killTweensOf(this.mesh.scale),this.mesh.scale.set(1,1,1)}playSniffAnimation(){this.currentAnimation="sniff";const e=this.mesh.children[1];xt.to(e.position,{z:e.position.z+.1,duration:.2,ease:"sine.inOut",repeat:3,yoyo:!0})}playDigAnimation(e){this.currentAnimation="dig",xt.to(this.mesh.position,{y:-.1,duration:.15,ease:"power2.inOut",repeat:4,yoyo:!0,onComplete:()=>{this.mesh.position.y=0,e&&e()}}),xt.to(this.mesh.scale,{y:.95,duration:.1,ease:"power2.inOut",repeat:7,yoyo:!0})}playExcitedAnimation(){this.currentAnimation="excited",xt.to(this.mesh.position,{y:.3,duration:.2,ease:"power2.out",yoyo:!0,repeat:2,onComplete:()=>{this.mesh.position.y=0,this.playIdleAnimation()}});const e=this.mesh.children[this.mesh.children.length-1];e&&xt.to(e.rotation,{z:e.rotation.z+Math.PI*2,duration:.5,ease:"power2.inOut"})}playConfusedAnimation(){this.currentAnimation="confused";const e=this.mesh.children[1];xt.to(e.rotation,{y:e.rotation.y+.3,duration:.1,ease:"sine.inOut",repeat:5,yoyo:!0,onComplete:()=>{e.rotation.y=0,this.playIdleAnimation()}})}dispose(){xt.killTweensOf(this.mesh),xt.killTweensOf(this.mesh.position),xt.killTweensOf(this.mesh.scale),this.mesh.children.forEach(e=>{xt.killTweensOf(e),xt.killTweensOf(e.position),xt.killTweensOf(e.rotation)})}}class XS{constructor(e,t){_e(this,"scene");_e(this,"assets");_e(this,"scentIndicators",new Map);_e(this,"truffleMeshes",new Map);_e(this,"activeScentIndicator",null);this.scene=e,this.assets=t}initializeScentSpots(e){this.clearAll(),e.forEach(t=>{this.createScentSpot(t)})}createScentSpot(e){const t=new In;t.position.set(e.position.x,.05,e.position.z),t.visible=!1;const n=new Ic(bn.scent.spotRadius,.5,32,1,!0),i=new oi({uniforms:{color:{value:new xe(St.scent)},opacity:{value:.3}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,this.container.appendChild(this.stateIndicator);const e=document.createElement("div");e.style.cssText=`
      ...
      width: 100%;
      max-width: 400px;
    `,this.container.appendChild(e),this.fiutoButton=this.createButton("FIUTO",St.buttonPrimary,()=>{const n=kt.getState();n.nearestScentSpot&&(n.setScentActive(!0),n.setDogSniffing(!0))}),this.fiutoButton.style.opacity="0",this.fiutoButton.style.pointerEvents="none",e.appendChild(this.fiutoButton),this.scavaButton=this.createButton("SCAVA",St.buttonAction,()=>{this.handleDig()}),this.scavaButton.style.opacity="0",this.scavaButton.style.pointerEvents="none",e.appendChild(this.scavaButton),this.truffleCounter=document.createElement("div"),this.truffleCounter.style.cssText=`
      position: absolute;
    ...
    `,i.addEventListener("touchstart",()=>{i.style.transform="scale(0.95)"}),i.addEventListener("touchend",()=>{i.style.transform="scale(1)"}),i.addEventListener("click",n),i}handleDig(){const e=kt.getState();!e.isDigAvailable||e.dogIsDigging||e.setDogDigging(!0)}setupSubscriptions(){kt.subscribe((e,t)=>{e.dogEmotionalState!==t.dogEmotionalState&&this.updateStateIndicator(e.dogEmotionalState),e.scentIntensity!==t.scentIntensity&&this.updateFiutoButton(e.scentIntensity>.3),e.isDigAvailable!==t.isDigAvailable&&this.updateScavaButton(e.isDigAvailable),e.collectedTruffles.length!==t.collectedTruffles.length&&this.updateTruffleCounter(e.collectedTruffles.length),e.phase!==t.phase&&this.handlePhaseChange(e.phase)})}updateStateIndicator(e){if(!this.stateIndicator)return;const n={[Lt.NEUTRAL]:"",[Lt.CURIOUS]:"🤔 Curioso",[Lt.CONVINCED]:"🎯 Convinto",[Lt.ALMOST]:"🔥 Quasi!",[Lt.CONFUSED]:"😕 Confuso"}[e];n?(this.stateIndicator.textContent=n,this.stateIndicator.style.opacity="1"):this.stateIndicator.style.opacity="0"}updateFiutoButton(e){this.fiutoButton&&(e?(this.fiutoButton.style.opacity="1",this.fiutoButton.style.pointerEvents="auto"):(this.fiutoButton.style.opacity="0",this.fiutoButton.style.pointerEvents="none"))}updateScavaButton(e){this.scavaButton&&(e?(this.scavaButton.style.opacity="1",this.scavaButton.style.pointerEvents="auto",this.scavaButton.style.animation="pulse 0.5s ease infinite"):(this.scavaButton.style.opacity="0",this.scavaButton.style.pointerEvents="none",this.scavaButton.style.animation="none"))}updateTruffleCounter(e){const t=document.getElementById("truffle-count");t&&(t.textContent=e.toString(),t.style.transform="scale(1.3)",setTimeout(()=>{t.style.transform="scale(1)"},200))}handlePhaseChange(e){e==="playing"?this.container.style.display="flex":this.container.style.display="none"}show(){this.container.style.display="flex"}hide(){this.container.style.display="none"}dispose(){var e;this.container.remove(),(e=this.truffleCounter)==null||e.remove()}}class YS{constructor(){_e(this,"container");var e;this.container=this.createHomeScreen(),(e=document.getElementById("app"))==null||e.appendChild(this.container)}createHomeScreen(){const e=document.createElement("div");e.id="home-screen",e.style.cssText=`
      ...
      align-items: center;
      justify-content: center;
      background: linear-gradient(180deg, ${St.grass.dark} 0%, ${St.dirt.dark} 100%);
      z-index: 50;
    ...
    `,t.appendChild(n);const i=e.filter(_=>_.type===ri.COMMON).length,s=e.filter(_=>_.type===ri.RARE).length,o=e.length,a=document.createElement("div");a.style.cssText=`
      ...
      gap: 15px;
      margin-bottom: 30px;
    `;const c=this.createStatRow("🍄 Tartufi comuni",i,St.dirt.dark);a.appendChild(c);const l=this.createStatRow("💎 Tartufi rari",s,St.rare);a.appendChild(l);const u=this.createStatRow("📦 Totale",o,St.buttonPrimary);a.appendChild(u),t.appendChild(a);const h=document.createElement("button");h.textContent="Rigioca",h.style.cssText=`
      background: ${St.buttonAction};
      color: white;
      border: none;
      padding: 15px 40px;
    ...
    `,f.addEventListener("click",()=>{this.hide(),kt.getState().resetGame()}),t.appendChild(f),this.container.appendChild(t),(d=document.getElementById("app"))==null||d.appendChild(this.container),t.style.opacity="0",t.style.transform="scale(0.9)",requestAnimationFrame(()=>{t.style.transition="all 0.3s ease",t.style.opacity="1",t.style.transform="scale(1)"})}createStatRow(e,t,n){const i=document.createElement("div");i.style.cssText=`
      ...
      border-radius: 10px;
    `;const s=document.createElement("span");s.textContent=e,s.style.color=St.textDark,i.appendChild(s);const o=document.createElement("span");return o.textContent=t.toString(),o.style.cssText=`
      background: ${n};
      color: white;
      padding: 5px 15px;
      border-radius: 15px;
...
//# sourceMappingURL=index-Ca1Byg46.js.map
